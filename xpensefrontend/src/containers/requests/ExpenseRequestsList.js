...
import { setExpenseRequests, setRegistrationRequests } from "../../features/core/coreSlice";
      ...
      <div className="w-full">
        ...
        <> */}
          <table className={table}>
            ...
            {!requests.length && <tr className="w-96 h-full flex-col-style justify-start bg-gray-100 text-xl font-light"><td>No requests found</td></tr>}
            {requests.length !== 0 && 
            <>
